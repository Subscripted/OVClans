...
public class UUIDFetcher {
    ...
    private static final String UUID_URL = "https://sessionserver.mojang.com/session/minecraft/profile/";
    ...
    public static UUID getUUIDAt(String name, long timestamp) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                System.err.println("Error fetching UUID for name: " + name + ". Response code: " + responseCode);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String getName(UUID uuid) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                System.err.println("Error fetching name for UUID: " + uuid + ". Response code: " + responseCode);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
